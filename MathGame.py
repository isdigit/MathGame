...
menu_item4 = lambda x : f"4) Lowest Integer ({x})" #{}low_bound
menu_item5 = lambda x : f"5) Highest Integer ({x})" #{}high_bound
...
input_msg_lowbound = "Enter the lowest random integer: "
input_msg_highbound = "Enter the highest random integer: "
input_msg_again = "Enter 'y' to play again with the same settings: "
error_msg_low_bound = "ERROR: Lowest integer must be less than highest!"
error_msg_high_bound = "ERROR: Highest integer must be greater than lowest!"
